    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center gap-3 px-4 py-5 border-b border-red-900/30">
        ...
        <div>
          ...
          <p className="text-xs text-zinc-400">Panel de Usuario</p>
        </div>
        {onClose && (
...
export default function UserLayout() {
  ...
  return (
    <div className="flex h-screen bg-[#0a0a0a] overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <header className="h-16 bg-[#111111]/90 backdrop-blur border-b border-red-900/30 flex items-center justify-between px-4 lg:px-6 flex-shrink-0">
          ...
          <div className="hidden lg:block">
            <h1 className="text-sm font-medium text-zinc-400">Bienvenido de vuelta,{' '}
              <span className="text-white font-semibold">{currentUser?.systemName || currentUser?.displayName}</span>
            </h1>
          </div>
      ...
      {/* Chatbot flotante — disponible en todo el panel */}
